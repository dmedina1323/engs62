...
HD_PWD='/thayerfs/home/f003wvc/workspace/module2/module2.runs/module2_hw_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log module2_hw_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source module2_hw_processing_system7_0_0.tcl
