...
HD_PWD='/thayerfs/home/f003wvc/workspace/module2/module2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log module2_hw_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source module2_hw_wrapper.tcl -notrace
