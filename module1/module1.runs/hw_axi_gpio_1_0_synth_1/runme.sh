...
HD_PWD='/thayerfs/home/f003xh9/workspace/module1/module1.runs/hw_axi_gpio_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hw_axi_gpio_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hw_axi_gpio_1_0.tcl
