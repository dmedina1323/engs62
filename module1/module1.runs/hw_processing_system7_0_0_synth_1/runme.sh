...
HD_PWD='/thayerfs/home/f003xh9/workspace/module1/module1.runs/hw_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hw_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hw_processing_system7_0_0.tcl
